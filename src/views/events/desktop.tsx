        ...
        <SimpleBlock isMobile={false}>
          ...
          <VStack spacing={4} alignItems="flex-start" bg="white" py={4} px={6} mt={4}>
            ...
            <HStack w="full">
              ...
              <Button as="a" href={`${URLS.BOOKING}?event=${searchParams.get("event")}`} fontSize="sm" w="full" color="white" bg="#D6B87C" colorScheme="orange">Continue&nbsp;&nbsp;<ChevronRightIcon boxSize="20px" /></Button>
            </HStack>
          </VStack>
        </SimpleBlock>
      </Box>
